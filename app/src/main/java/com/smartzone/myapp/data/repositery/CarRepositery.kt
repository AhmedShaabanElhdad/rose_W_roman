...
class CarRepositery(private val apiHelper: APIHelper){
    ...
    fun add_cart(user_id:String,city_id:String,promocode:String,map:Map<String,String>):Single<BaseObjectResponse>{
        return apiHelper.add_cart_multiple(user_id,city_id,map,promocode)
    }
